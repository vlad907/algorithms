...
// CODE HERE (FUNCTION PROTOTYPE)
<<<<<<< HEAD
int GetStats(const string &word, int &x, int &y);
=======
...
// CODE HERE (FUNCTION PROTOTYPE)
<<<<<<< HEAD
string BuildMessage(const string &word = "",const bool &t_or_f = false );
=======
...
string BuildMessage(const string &word, const bool &t_or_f ){
 std::stringstream ss;
