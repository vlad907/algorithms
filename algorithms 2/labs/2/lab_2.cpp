...
<<<<<<< HEAD
  ...
  x_velocity = initial_velocity * cos(launch_angle);
=======
...
<<<<<<< HEAD
  ...
  final_vertical = initial_velocity * sin(launch_angle) * -1 ; 
  // (4) Compute time of flight 
  //     [flight_time = (y_velocity) * 2 / -9.8]
  // CODE HERE
  double time_of_flight = 0;
  time_of_flight = (final_vertical) * 2 / -9.8;
  // (5) Compute horizontal/x distance travelled
  //     [x_distance = x_velocity * flight_time]
  // CODE HERE
  double compute_horizontal = 0;
  compute_horizontal = x_velocity * time_of_flight;
